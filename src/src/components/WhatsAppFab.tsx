...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="whatsapp-action fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition-transform hover:scale-110"
    >
